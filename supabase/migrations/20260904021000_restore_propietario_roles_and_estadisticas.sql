-- Restaura el rol Propietario en seed_organization_roles (se perdió al
-- añadir estadísticas) y otorga estadísticas a todas las sucursales.
...
WHERE r.slug IN ('propietario', 'administrador')

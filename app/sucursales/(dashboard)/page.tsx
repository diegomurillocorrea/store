  ...
  return (
    <div className="flex w-full flex-col gap-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <Heading>Mis sucursales</Heading>
          <Text className="mt-2">Elige un negocio o crea uno nuevo.</Text>
        </div>
        <Button href="/sucursales/nueva" color="dark/zinc" className="shrink-0">
          Nueva sucursal
        </Button>
      </div>
      ...
      {memberships.length === 0 ? (
        <div className="rounded-2xl border border-zinc-200 bg-white p-8 dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <Button href="/sucursales/nueva" className="mt-6" color="dark/zinc">
            Crear sucursal
          </Button>
        </div>
      ) : (

...
export function LoginForm() {
  ...
  const safeNextPath = nextPath.startsWith('/') ? nextPath : '/orgs'
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm/6">
              <button
                ...
                disabled={isPending}
                className="font-semibold text-emerald-600 hover:text-emerald-500 disabled:opacity-50 dark:text-emerald-400 dark:hover:text-emerald-300"
              >
        ...
        <div className="mt-10">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm/6 font-medium">
              <span className="bg-white px-6 text-gray-900 dark:bg-zinc-950 dark:text-white">
                O continúa con
              </span>
            </div>
          </div>

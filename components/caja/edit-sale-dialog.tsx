            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  disabled={pending}
                  className="block w-full rounded-xl border border-zinc-200 bg-white py-3 pr-11 pl-3.5 text-sm text-zinc-800 outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
                  aria-label={`Fecha de la venta: ${saleDate ? formatSaleDate(`${saleDate}T12:00:00`) : ''}`}
                />
                <CalendarDaysIcon
                  className="pointer-events-none absolute top-1/2 right-3.5 size-5 -translate-y-1/2 text-zinc-400"
                  aria-hidden="true"
                />
              </div>
            </div>
